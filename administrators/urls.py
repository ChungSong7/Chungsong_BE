...
from .views import NewUserView,RoomRequestView,FreezeView,AdminDeleteView,SchoolListView,SchoolBoardListView,UseridInfoView,UseridInfoView2
...
urlpatterns = [
    ...
    path('userid_info2/<uuid:user_id>/',UseridInfoView2.as_view(),name='UseridInfo2')
