...
class Complain(models.Model):
    ...
    comp_post = models.ForeignKey(Post, blank= True, null = True, on_delete=models.SET_NULL)
    comp_comment = models.ForeignKey(Comment, blank= True, null = True, on_delete=models.SET_NULL)
    ...
    category = models.CharField(verbose_name='신고사유', choices=CATEGOTY_CHOICES)
