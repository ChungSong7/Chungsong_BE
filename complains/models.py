...
class Complain(models.Model):
    ...
    comp_user = models.ForeignKey(User,verbose_name='신고자', on_delete=models.SET_NULL,null=True)
    comped_user = models.ForeignKey(User,verbose_name='피신고자', on_delete=models.SET_NULL,null=True, related_name='complains')
